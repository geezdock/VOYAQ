...
export function LandingHeader() {
  ...
  return (
    <header className="flex items-center justify-between border-2 border-ink rounded-bruted-lg bg-surface-card px-3 sm:px-6 py-2 sm:py-3 shadow-bruted max-w-[1200px] mx-auto w-full">
